...
import static io.github.longluo.baseframework.BaseActivity.isNull;
import static io.github.longluo.baseframework.BaseFrameworkSettings.BETA_PLAN;
...
public class DebugLogG {
    ...
    public static String getCodeLineStr(boolean showStack) {
        ...
        for (int i = 0; i < stackTraceElements.length; i++) {
            if (stackTraceElements[i].getClassName().startsWith("io.github.longluo.baseframework.")) {
                findFrameworkPackage = true;
            }
            if (findFrameworkPackage && !stackTraceElements[i].getClassName().startsWith("io.github.longluo.baseframework.")) {
                line = i;
                break;
            }
        }
