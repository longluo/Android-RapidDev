...
import com.longluo.android.App;
import com.longluo.android.R;
import com.longluo.android.bean.User;
import com.longluo.android.ui.activity.AdapterTestActivity;
import com.longluo.android.ui.activity.DemoActivity;
import com.longluo.android.ui.activity.JumpActivity;
import com.longluo.android.ui.activity.ResponseActivity;
import com.longluo.android.ui.activity.TransitionActivity;
    ...
    public void setEvents() {
        ...
        btnPrintMapLog.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                map.put("name", "longluo");
                map.put("website", "longluo.me");
                map.put("times", 20);
                map.put("signed", true);
                log(map);
