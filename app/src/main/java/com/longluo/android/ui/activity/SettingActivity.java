...
import com.longluo.android.http.api.LogoutApi;
...
import com.longluo.android.manager.ThreadPoolManager;
        ...
        if (viewId == R.id.sb_setting_language) {
            ...
            new MenuDialog.Builder(this)
                    ...
                    .setListener((MenuDialog.OnListener<String>) (dialog, position, string) -> {
                        ...
                        BrowserActivity.start(getActivity(), "https://github.com/longluo/Android_Dev_Quick");
                    })
