package io.github.longluo.library.umeng;
...
//        UMConfigure.init(application, BuildConfig.UM_KEY, "umeng", UMConfigure.DEVICE_TYPE_PHONE, "");
        UMConfigure.init(application, "61bc361fe014255fcbbb8876", "umeng", UMConfigure.DEVICE_TYPE_PHONE, "");
        // 获取设备的 oaid
...
//        UMConfigure.preInit(application, BuildConfig.UM_KEY, "umeng");
        UMConfigure.preInit(application, "61bc361fe014255fcbbb8876", "umeng");
